...
remollBOptrChangeCrossSection::remollBOptrChangeCrossSection(G4String particleName,
                                                         G4String         name)
  ...
  if ( fParticleToBias == 0 )
    {
      ...
      G4Exception("remollBOptrChangeCrossSection(...)",
                  "exremoll.01",
                  JustWarning,
                  ed);
    }
...
remollBOptrChangeCrossSection::~remollBOptrChangeCrossSection()
{
...
void remollBOptrChangeCrossSection::StartRun()
{
  // --------------
  // -- Setup stage:
  // ---------------
...
G4VBiasingOperation*
remollBOptrChangeCrossSection::ProposeOccurenceBiasingOperation(const G4Track*            track,
      ...
      if (  previousOperation != operation )
        {
          ...
          G4Exception("remollBOptrChangeCrossSection::ProposeOccurenceBiasingOperation(...)",
                      "exremoll.02",
                      JustWarning,
                      ed);
          return 0;
...
void remollBOptrChangeCrossSection::
