...
void test_general (const TString& inputdir, const TString& inputname)
{
  ...
  T.Draw("part.vx >> h_vx(200,-0.010,+0.010)","",hopt);
  c1.SaveAs(outputdir + "/" + inputname + "_" + "h_vx.png");
  T.Draw("part.vy >> h_vy(200,-0.010,+0.010)","",hopt);
  c1.SaveAs(outputdir + "/" + inputname + "_" + "h_vy.png");
  T.Draw("part.vz >> h_vz(200,-1.00,+1.00)","",hopt);
  ...
  T.Draw("ev.beamp:part.vz >> h_beamp_vz(20,-1.0,+1.0)","",hopt+",PROF");
