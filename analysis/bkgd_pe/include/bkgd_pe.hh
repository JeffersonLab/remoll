...
simPEs_t simPEsTrim(std::vector<int> sourcedetids, std::vector<int> quartzpids, std::vector<int> quartzmtrids, double nPEs, std::vector<double> cathitx, std::vector<double> cathity, std::vector<double> cathitz)
{
    simPEs_t newHit;
    newHit.npes=nPEs;
