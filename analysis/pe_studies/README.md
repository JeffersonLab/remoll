...
* variable-to-scan: Typing "angle" or "x" or "d" (for depth, only in ref-scan atm) here refers to whether the scan is over "angle" or "x" or "d", with the other variable held fixed, at the value given in the previous argument. Angle is in degrees, and x/d are in cm.
