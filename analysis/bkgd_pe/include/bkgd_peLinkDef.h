...
#pragma link C++ struct simPEs_t+;
#pragma link C++ struct catPEs_t+;
#pragma link C++ struct Q_t+;
#pragma link C++ struct Ref_t+;
#pragma link C++ struct RefX_t+;
#pragma link C++ struct Refair_t+;
#pragma link C++ struct LG_t+;
#pragma link C++ struct LGair_t+;
#pragma link C++ struct PMTcat_t+;
#pragma link C++ struct PMTbulk_t+;
#pragma link C++ struct elseX_t+;

#pragma link C++ struct vector<simPEs_t>+;
