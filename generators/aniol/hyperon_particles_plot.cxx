...
TH1F *Prad = new TH1F("Prad","Prad distribution of pions,h=-1", 200, 0,2.);
TH1F *Pmag = new TH1F("Pmag","Pmag distribution of pions,h=-1", 200, 0,2.0);
TH2F *h2 = new TH2F("h2","Zpos vs Pmag for pions,h=-1",350,-150,200, 200,0,2.);
TH2F *h3 = new TH2F("h3","Radial_pos vs Pmag for pions,h=-1",55,-5,50, 200,.0,2.);
...
TCanvas *c1 = new TCanvas("c1","decay particle Z position",40,40,1000,1000);
c1->Divide(1);
c1->cd(1);
Z->Draw();

TCanvas *c2 = new TCanvas("c2"," decay particle Rad position",40,40,1000,1000);
c2->Divide(1);
c2->cd(1);
Rad->Draw();

TCanvas *c3 = new TCanvas("c3","Px of decay particle",40,40,1000,1000);
c3->Divide(1);
c3->cd(1);
Px ->Draw();

TCanvas *c4 = new TCanvas("c4","Py of decay particle",40,40,1000,1000);
c4->Divide(1);
c4->cd(1);
Py->Draw();

TCanvas *c5 = new TCanvas("c5","Pz of decay particle",40,40,1000,1000);
c5->Divide(1);
c5->cd(1);
Pz->Draw();

TCanvas *c6 = new TCanvas("c6","Prad of decay particles",40,40,1000,1000);
c6->Divide(1);
c6->cd(1);
Prad ->Draw();

TCanvas *c7 = new TCanvas("c7","Pmag of decay particles",40,40,1000,1000);
c7->Divide(1);
c7->cd(1);
Pmag->Draw();

TCanvas *c8 = new TCanvas("c8","Zpos vs Pmag of deca particles",40,40,1000,1000);
c8->Divide(1);
c8->cd(1);
h2->Draw();

TCanvas *c9 = new TCanvas("c9","Rpos vs Pmag of decay particles",40,40,1000,1000);
c9->Divide(1);
c9->cd(1);
h3->Draw();

TCanvas *c10 = new TCanvas("c10","Zpos vs Pmag of decay particles",40,40,1000,1000);
c10->Divide(1);
c10->cd(1);
h2->Draw("SPEC dm(1,10) pa(2,1,1) ci(1,4,8) a(15,65,180)");

TCanvas *c11 = new TCanvas("c11","Rpos vs Pmag of decay particles",40,40,1000,1000);
c11->Divide(1);
c11->cd(1);
h3->Draw("SPEC dm(1,10) pa(2,1,1) ci(1,4,8) a(15,65,180)");

TCanvas *c12 = new TCanvas("c12","radial position vs Z of decay particles",40,40,1000,1000);
c12->Divide(1);
c12->cd(1);
h4->Draw();

TCanvas *c13 = new TCanvas("c13","radial position vs Z of decay particles",40,40,1000,1000);
c13->Divide(1);
c13->cd(1);
