...
*/
  ...
  TH1F *Prad =
    new TH1F ("Prad", "Prad distribution of pions,h=-1", 60, 0, 0.6);
  TH1F *Pmag =
    new TH1F ("Pmag", "Pmag distribution of pions,h=-1", 200, 0, 2.0);
  TH2F *h2 =
    new TH2F ("h2", "Zpos vs Pmag for pions,h=-1", 350, -150, 200, 300, 0,
	      3.);
  TH2F *h3 =
    new TH2F ("h3", "Radial_pos vs Pmag for pions,h=-1", 55, -5, 50, 80, .0,
	      .8);
  TH2F *h4 =
...
*/
  ...
  TCanvas *c8 =
    new TCanvas ("c8", "Zpos vs Pmag of pions", 40, 40, 1000, 1000);
  c8->Divide (1);
  c8->cd (1);
  h2->Draw ();

  TCanvas *c9 =
    new TCanvas ("c9", "Rpos vs Pmag of pions", 40, 40, 1000, 1000);
  c9->Divide (1);
  c9->cd (1);
  h3->Draw ();

  TCanvas *c10 =
    new TCanvas ("c10", "Zpos vs Pmag of pions", 40, 40, 1000, 1000);
  c10->Divide (1);
  c10->cd (1);
  h2->Draw ("SPEC dm(1,10) pa(2,1,1) ci(1,4,8) a(15,65,180)");

  TCanvas *c11 =
    new TCanvas ("c11", "Rpos vs Pmag of pions", 40, 40, 1000, 1000);
  c11->Divide (1);
  c11->cd (1);
  h3->Draw ("SPEC dm(1,10) pa(2,1,1) ci(1,4,8) a(15,65,180)");

  TCanvas *c12 =
    new TCanvas ("c12", "radial posotion vs Z of pions", 40, 40, 1000, 1000);
  c12->Divide (1);
  c12->cd (1);
  h4->Draw ();

  TCanvas *c13 =
    new TCanvas ("c13", "radial position vs Z of pions", 40, 40, 1000, 1000);
  c13->Divide (1);
  c13->cd (1);
